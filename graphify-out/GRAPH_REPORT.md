# Graph Report - RAG_Benchmarking_and_Monitoring_Platform  (2026-05-11)

## Corpus Check
- 94 files · ~12,144 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 484 nodes · 958 edges · 34 communities detected
...
Cohesion: 0.09
Nodes (27): ABC, RetrievalResult, EmbeddingProvider, OpenAIEmbeddingProvider, SentenceTransformerEmbeddingProvider, QueryTransformer, RetrievalFactory, _average_length() (+19 more)

### Community 1 - "Community 1"
Cohesion: 0.07
Nodes (21): TextChunk, ContextCompressor, CachedEmbeddingProvider, HashEmbeddingProvider, Deterministic local fallback used for tests and offline development., build_embedding_provider(), build_vector_store(), BGEReranker (+13 more)
...
Cohesion: 0.44
Nodes (12): $(), apiBase(), evaluateAnswer(), loadSummary(), renderLeaderboard(), renderSources(), renderSummary(), request() (+4 more)
...
- **Why does `TextChunk` connect `Community 1` to `Community 0`, `Community 2`, `Community 5`, `Community 6`, `Community 7`?**
  _High betweenness centrality (0.259) - this node is a cross-community bridge._
- **Why does `RagService` connect `Community 6` to `Community 0`, `Community 1`, `Community 3`, `Community 7`, `Community 9`?**
  _High betweenness centrality (0.132) - this node is a cross-community bridge._
- **Why does `EvaluationEngine` connect `Community 2` to `Community 1`, `Community 3`, `Community 6`?**
